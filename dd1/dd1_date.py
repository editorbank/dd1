...
_DATE_LIKE = ree(f"""
  (
    ({_YY}|{_Y4})({_MM}{_DD}|{_DD}{_MM})|
    ({_MM}{_DD}|{_DD}{_MM})({_YY}|{_Y4})|
    ({_YY}|{_Y4}){_S}({_MM}{_S}{_DD}|{_DD}{_S}{_MM})|
    ({_MM}{_S}{_DD}|{_DD}{_S}{_MM}){_S}({_YY}|{_Y4})|
  )
""")
DD1_DATE_LIKE = f"^{_DATE_LIKE}$"
DD1_DATETIME_LIKE = f"^{_DATE_LIKE}{_S}{_HH}{_S}{_59}({_S}{_59})?$"
